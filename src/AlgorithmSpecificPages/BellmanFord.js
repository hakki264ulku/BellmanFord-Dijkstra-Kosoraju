...
function Bellman() {
    ...
    function handleBellmanFord() {
        ...
        let source = prompt("Please enter the source vertex to calculate Bellman Ford")

        let dist = graph.BellmanFord(parseInt(source))
        setDistances(dist)
    }
        ...
        <BellmanContainer>
            <Container>
                ...
                <Buttons>
                    ...
                    <Button onClick={() => handleBellmanFord()}>Bellman Ford</Button>
                </Buttons>
                ...
                <TableContainer>
                    <TableInfo>Result of Bellman Ford</TableInfo>
                    <InfoTable>
                        <InfoRow>
